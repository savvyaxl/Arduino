    ...
    while True:
        ...
        try:
            if poller.poll(0):  # Check for incoming connections
                ...
                ContentType = f"Content-Type: text/html\r\n\r\n"

                response = f"""{HTTP_OK}{ContentType}
                <html><body><h1>Temp: {sensor.last_temperature}°C, Humidity: {sensor.last_humidity}%</h1></body></html>"""
