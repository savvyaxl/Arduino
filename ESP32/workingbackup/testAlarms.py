...
daily = AlarmDaily()
daily.add_alarm(20, 53, 0, lambda: print("1 BEEP BEEP!")) # Example daily alarm at 7:30 AM
daily.add_alarm(20, 53, 20, lambda: print("2 BEEP BEEP!")) # Example daily alarm at 2:02 PM
daily.list_alarms()
weekly = AlarmWeekly()
weekly.add_weekly_alarm([0, 2, 4], 8, 0, 0, lambda: print("Time to work!")) # Example weekly alarm on Mon/Wed/Fri at 8:00 AM
weekly.list_alarms()
